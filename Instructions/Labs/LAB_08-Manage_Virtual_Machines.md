...
1. **다음: 고급 >**을 클릭합니다, **가상 머신 만들기** 블레이드의 **관리** 탭에서 아무 것도 수정하지 않고 사용 가능한 설정을 검토하고 **검토+만들기**를 클릭합니다.
...
1. **확장 설치** 블레이드 에서 **\\Allfiles\\Labs\\08**의 스크립트 **az104-08-install_IIS.ps1**를 업로드하고 **확인**을 클릭합니다.  
...
1. **실행 명령 스크립트 **블레이드에서 다음 내용을 입력하고 **실행**을 클릭하여 간단한 레이아웃 및 고정 프로비전이 있는 두 개의 새로 연결된 디스크로 구성된 드라이브 Z를 만듭니다:
...
1. **확장 설치** 블레이드 중 **\\Allfiles\\Labs\\08**에서 스크립트 **az104-08-install_IIS.ps1**로 업로드하고 **확인**을 클릭합니다.  
