...
1. **액세스 제어(IAM)** 를 클릭하고 **역할 할당** 다음에 **+ 추가**를 클릭하고 새로 만든 사용자 계정에 **Support Request Contributor (Custom)** 역할을 할당합니다.
...
1. **InPrivate** 브라우저 창에 있는 **도움말+지원-새 지원 요청** 블레이드의 **기본** 탭에서 **서비스 및 구독 제한(할당량)** 문제 유형을 선택하고 이 랩에서 사용 중인 구독이 **Subscription** 드롭다운 목록에 나열되어 있는지 확인합니다.
