...
1. **다음: 스케일 >**을 클릭합니다 그리고, **Kubernetes 클러스터 만들기** 블레이드의 **스케일** 탭에서 다음 설정을 지정합니다 (다른 설정은 기본값으로 남겨두세요).
...
1. **다음: 모니터링 >**을 클릭하고 **Kubernetes 클러스터 만들기** 블레이드의 **모니터링** 탭에서 **컨테이너 모니터링 사용**을 **아니요**로 설정하고 **검토 + 만들기**를 클릭한 다음 **만들기**를 클릭합니다. 
