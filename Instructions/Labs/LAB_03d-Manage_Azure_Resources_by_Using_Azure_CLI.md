...
# 랩 03d - Azure CLI를 사용한 Azure 리소스 관리
# 학생 랩 매뉴얼

## 랩 시나리오

Azure Portal, Azure Resource Manager 템플릿 및 Azure PowerShell을 사용하여 리소스 그룹을 기반으로 한 리소스 프로비전 및 구성과 관련된 기본 Azure 관리 기능을 살펴보았으므로 이제 Azure CLI를 사용하여 동등한 작업을 수행해야 합니다. Azure CLI를 설치하지 않으려면 Azure Cloud Shell에서 사용할 수 있는 Bash 환경을 활용해야 합니다.
...
1. Cloud Shell 창의 왼쪽 위 모서리에 있는 드롭다운 메뉴에 **Bash**가 나타나는지 확인합니다.
...
1. Azure Portal의 **Cloud Shell** 창 내에서 **Bash** 세션을 시작합니다.
...
- Azure Cloud Shell에서 Bash 세션을 시작
